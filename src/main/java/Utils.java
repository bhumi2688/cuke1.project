...
//    {
  ...
  //      Assert.assertEquals(actualText,getTextByAttributeValue(by,attributeValue ));
    ...
    //}
    //public void assertByGetText(String result, RegistrationSuccessMessagepage your_registration_completed){
    ...
    //Assert by get text element
    public String getTextFromElement(By by)
    {
return driver.findElement(by).getText();
    }
    //return text from Webemelemt
